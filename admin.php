...
<body>
    ...
    <nav>
        ...
        <ul>
            ...
            <li class="active"><a href="/admin.html">produtos</a></li>
    ...
    <main>
        ...
        <div class="lista">
            ...
            <div class="produto">
                <div class="data">
                    <div class="img">
                        <img src="<?= $lanche ->getImagemPath() ?>" alt="food">
                    </div>
                    <div class="info">
                ...
                <div class="actions">
                    <form action="excluir.php" method="post">
                        <input type="hidden" name="id" value="<?= $lanche ->getId() ?> "/>
                    ...
                    <a href="/edit.php?id=<?= $lanche ->getId() ?>" class="icon edit">
